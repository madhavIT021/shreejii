...
const ProductInfo = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const agroChemicalResponse = await axios.get('https://api.shreejiinternationals.in/products/agrochemical');
                const organicResponse = await axios.get('https://api.shreejiinternationals.in/products/organic');
                const inorganicResponse = await axios.get('https://api.shreejiinternationals.in/products/inorganic');
